  ...
  <header class="header">
    <div class="header-group">
      ...
      <div class="flex flex-col mt-28">
        <h1 class="text-4xl font-black text-white">Tenha um feedbacker. <br>
          E faça seus clientes mais <br class="hidden lg:block">
          felizes!
        </h1>
        <p class="text-lg font-medium text-white">
          Receba ideias, reclamações e feedbacks com um <br class="hidden lg:block">
